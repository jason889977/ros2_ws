    ...
    return [
            Node(
                ...
                additional_env={
                    ...
                    'GENICAM_GENTL64_PATH': os.path.join(
                        pylon_root, 'lib', 'gentlproducer', 'gtl'
                    ),
                },
                parameters=[
                    config_file,
...
def generate_launch_description():
    ...
    declare_mtu_size_cmd = DeclareLaunchArgument(
        ...
        default_value='1500',
        description=(
            'Maximum transfer unit size. To enable jumbo frames, '
            'set it to a high value (8192 recommended)'
        )
    )
